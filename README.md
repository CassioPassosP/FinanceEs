...
(Adicione prints do sistema aqui — login, dashboard, etc.)

🎯 Objetivo do Projeto

Este projeto foi desenvolvido como parte da disciplina de Projeto Final, com foco na construção de um sistema completo utilizando boas práticas de desenvolvimento, incluindo:
